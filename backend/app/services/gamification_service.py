...
class GamificationService:
    ...
    BADGES = {
        "first_message":   {"name": "First Words",      "desc": "Send your first message", "xp_required": 0},
        "chatterbox":      {"name": "Chatterbox",       "desc": "Send 50 messages",        "xp_required": 250},
        "tcp_master":      {"name": "TCP Master",       "desc": "Send 100 TCP messages",   "xp_required": 500},
        "udp_speedster":   {"name": "UDP Speedster",    "desc": "Send 100 UDP messages",   "xp_required": 500},
        "crypto_knight":   {"name": "Crypto Knight",    "desc": "Send 50 encrypted msgs",  "xp_required": 300},
    }

    XP_PER_MESSAGE = 5
    XP_PER_LEVEL = 100

    def award_xp(self, user: dict, amount: int = None) -> dict:
