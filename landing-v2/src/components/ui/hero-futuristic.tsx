  ...
  return (
    <section className="relative w-full" style={{ minHeight: '100vh', background: '#000' }}>
      <div className="h-svh uppercase items-center w-full absolute z-60 pointer-events-none px-10 flex justify-center flex-col">
        ...
        <div className="text-xs md:text-xl xl:text-2xl 2xl:text-3xl mt-2 overflow-hidden text-white font-bold" style={{ textShadow: '0 0 20px rgba(0, 0, 0, 0.5)' }}>
          <div
      ...
      <div
        ...
        style={{
          position: 'absolute', bottom: '32px', left: '50%', transform: 'translateX(-50%)', zIndex: 60,
          display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '8px',
          color: 'rgba(255,255,255,0.5)', fontSize: '12px', fontWeight: 500, letterSpacing: '0.1em',
          opacity: subtitleVisible ? 1 : 0, transition: 'opacity 0.7s ease', transitionDelay: '2s'
        }}
      >
